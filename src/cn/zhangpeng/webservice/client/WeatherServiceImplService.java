 ...
 * 
 */
@WebServiceClient(name = "WeatherServiceImplService", targetNamespace = "http://serviceimpl.webservice.zhangpeng.cn/", wsdlLocation = "http://192.168.2.105:8888/weather?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEATHERSERVICEIMPLSERVICE_QNAME = new QName("http://serviceimpl.webservice.zhangpeng.cn/", "WeatherServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.2.105:8888/weather?wsdl");
    ...
    public WeatherServiceImpl getWeatherServiceImplPort() {
        return super.getPort(new QName("http://serviceimpl.webservice.zhangpeng.cn/", "WeatherServiceImplPort"), WeatherServiceImpl.class);
    }
    ...
    public WeatherServiceImpl getWeatherServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://serviceimpl.webservice.zhangpeng.cn/", "WeatherServiceImplPort"), WeatherServiceImpl.class, features);
    }
